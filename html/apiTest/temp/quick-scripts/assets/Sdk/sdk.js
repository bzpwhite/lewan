...
cc._RF.push(module, '375a3+tnfFJPLBwNEv7vy8U', 'sdk', __filename);
// Sdk/sdk.js
    ...
    */
    ...
    capture: function capture(callback) {
        if (cc.ENGINE_VERSION < "2.0.0") {
            ...
            var _width = this.texture.width;
            var _height = this.texture.height;
            ...
            for (var row = 0; row < _height; row++) {
                var srow = _height - 1 - row;
                var imageData = ctx.createImageData(_width, 1);
                var start = srow * _width * 4;
            ...
            var tempFilePath = _canvas.toTempFilePathSync({
                x: 0,
                y: 0,
                width: _width,
                height: _height,
